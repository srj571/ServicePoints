...
public class TC61_VerifyChangeDiscountWithRefundFunctionality extends BaseClass{

	
	ReadConfig rd = new ReadConfig();
	public String product61 = rd.getProductForTC61();
	...
	public void submitAndAcceptQuotation() throws InterruptedException, IOException {
		...
		aspp.searchProductName(product61);
		Thread.sleep(3000);
	...
	public void verifyAddTrackingOnProduct() throws InterruptedException, IOException {
		...
		aop.searchPnameTrack(product61);
	...
	public void raiseRefundDispute() throws InterruptedException, IOException {
		...
		cop.sendPnameinSearch(product61);
		logger.info("Product name is entered.");
		Thread.sleep(2000);
		...
		cop.clickOnFirstTwoCheckBoxesForOpenDispute();
		Thread.sleep(3000);
		...
		asop.searchProductForDsp(product61);
		Thread.sleep(3000);
...
//		Thread.sleep(2000);
		...
		AssertJUnit.assertEquals(expErrorMsg, actErrorMsg);
		Thread.sleep(2000);
	...
	public void raiseRefundDisputeAgain() throws InterruptedException, IOException {
		driver.get(baseURL);
