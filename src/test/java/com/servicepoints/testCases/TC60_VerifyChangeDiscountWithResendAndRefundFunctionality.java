...
public class TC60_VerifyChangeDiscountWithResendAndRefundFunctionality extends BaseClass {
	...
	public void submitAndAcceptQuotation() throws InterruptedException, IOException {
		...
		aspp.searchProductName(product60);
		Thread.sleep(3000);
	...
	public void raiseResendDispute() throws InterruptedException, IOException {
		...
		cop.sendPnameinSearch(product60);
		logger.info("Product name is entered.");
		Thread.sleep(2000);
...
//		Thread.sleep(3000);
	...
	public void verifyAddingDiscountOnRemainingVariants() throws InterruptedException {
		driver.get(baseURL);
		LoginPage lp = new LoginPage(driver);
